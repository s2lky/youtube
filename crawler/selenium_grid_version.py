...
def user_session():
    viewing_time = random.randint(1, 3)
    time.sleep(viewing_time * 1)
    return viewing_time
...
if __name__ == "__main__":
    ...
    server = "http://54.180.92.184:4445/wd/hub"
    driver = Remote(command_executor=server, options=chrome_options)
